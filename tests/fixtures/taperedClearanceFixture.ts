...
export const makeTaperedClearanceInput = (): Repair04SolverInput => {
  ...
  const route: RepairRoutePoint[] = [
    { x: -1.5641231147677717, y: -2.520505529440414, z: 0, traceThickness: 0.18897317564023802 },
    { x: -1.5177966918973158, y: -2.474254037565495, z: 0, traceThickness: 0.18213210116929335 },
    { x: -1.4825694438376706, y: -2.452939381040713, z: 0, traceThickness: 0.177946351280476 },
    { x: -1.3940422507399868, y: -2.4163966056781896, z: 0, traceThickness: 0.166919526920714 },
  ]
  ...
  return { srj, routes, bounds: srj.bounds, boundaryMargin: 0.8, lockedPointIndices: [[true, false, false, true]], allowLayerChanges: false }
}
...
export const makeTaperedPolylineInput = (): Repair04SolverInput => {
  ...
  route.route = [
    { x: -1.6718505005257336, y: -2.6505605147833267, z: 0, traceThickness: 0.2 } as RepairRoutePoint,
    ...route.route,
    { x: -1.378925005065849, y: -2.4142577630815043, z: 0, traceThickness: 0.16516225833229548 } as RepairRoutePoint,
  ]
